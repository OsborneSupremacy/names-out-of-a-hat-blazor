...
public class GiftExchangeProviderTests : IClassFixture<DynamoDbFixture>
{
    ...
    public async Task GetOrganizerHatsAsync_GivenExistingOrganizerEmail_ShouldReturnHats()
    {
        ...
        result.Should().BeEquivalentTo([
            new HatMetaData { HatId = hatOne.HatId, HatName = hatOne.HatName, InvitationsQueued = false },
            new HatMetaData { HatId = hatTwo.HatId, HatName = hatTwo.HatName, InvitationsQueued = false }
        ]);
    }
